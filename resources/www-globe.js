...
function FsGlobe() {
  ...
  //white bottom light
  var pointLight3 = new THREE.DirectionalLight(0x333333, 3);
  pointLight3.position.set(10, -5, 1);
  //cyan top light
  var pointLight4 = new THREE.DirectionalLight(0x6dc9f0, 1);
  pointLight4.position.set(-1, 4, -1);
  //blue right light
  var pointLight = new THREE.DirectionalLight(0x473af0, 4);
  pointLight.position.set(10, 4, -2);
  //teal left light
  var pointLight2 = new THREE.DirectionalLight(0x3dceb7, 2);
...
//# sourceMappingURL=/sm/bb7cd47bcceecaa983b41b3f941dac6a8596609db1bc5fba38727d03339bf9a3.map
