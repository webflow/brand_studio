    ...
    (function () {
      ...
      for (const [n, d] of m.entries()) {
        ...
        if (((g.className = "fs-3dglobe-arrow-box"), a[n])) g.appendChild(a[n]);
          ...
          (t.className = "logo_dot"), (t.position = "relative"), t.setAttribute("alt", m), t.setAttribute("src", u), (t.style.cursor = "auto"), (t.style.width = "50px"), e.appendChild(t), g.appendChild(e);
        }
