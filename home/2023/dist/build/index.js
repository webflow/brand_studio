(() => {
  ...
  function highlightGlint() {
    ...
    function onMouseMove(e2) {
      ...
      const glowX = e2.clientX - rect.left - rect.width / 2;
      const glowY = e2.clientY - rect.top - rect.height / 2;
      gsapWithCSS.to(glintGlow, {
        x: glowX,
        y: glowY,
        duration: 0.3,
        ease: "power2.out"
  ...
  function highlightBacklight() {
    ...
    highlightTargets.forEach((target) => {
      ...
      target.addEventListener("mousemove", function(e2) {
        ...
        const dirX = e2.clientX - centerX;
        const dirY = e2.clientY - centerY;
  ...
  function initSliderFade() {
    gsapWithCSS.set("[slide-trusted]", { x: "10rem", autoAlpha: 0 });
    const triggerTrust = ScrollTrigger2.create({
      trigger: "[ts-swiper]",
      start: "top 90%",
      onEnter: () => {
        gsapWithCSS.to("[slide-trusted]", {
          duration: 1.5,
          stagger: 0.2,
          x: "0rem",
          autoAlpha: 1,
    ...
    gsapWithCSS.set("[slide-started]", { x: "10rem", autoAlpha: 0 });
    const triggerStarted = ScrollTrigger2.create({
      trigger: "[gs-swiper]",
      start: "top 90%",
      onEnter: () => {
        gsapWithCSS.to("[slide-started]", {
          duration: 1.5,
          stagger: 0.2,
          x: "0rem",
          autoAlpha: 1,
  ...
  var _recordProps = function _recordProps2(elState, props) {
    var getProp = gsap4.getProperty(elState.element, null, "native"), obj = elState.props = {}, i2 = props.length;
    while (i2--) {
  ...
  var ElementState = /* @__PURE__ */ function() {
    ...
    _proto2.update = function update2(props, simple) {
      var self = this, element = self.element, getProp = gsap4.getProperty(element), cache = gsap4.core.getCache(element), bounds = element.getBoundingClientRect(), bbox = element.getBBox && typeof element.getBBox === "function" && element.nodeName.toLowerCase() !== "svg" && element.getBBox(), m = simple ? new Matrix2D(1, 0, 0, 1, bounds.left + _getDocScrollLeft(), bounds.top + _getDocScrollTop()) : getGlobalMatrix(element, false, false, true);
  ...
  // node_modules/.pnpm/gsap@3.12.2/node_modules/gsap/utils/paths.js
  ...
  var _splitSegment = function _splitSegment2(rawPath, segIndex, i2, t2) {
  ...
  function getRotationAtBezierT(segment, i2, t2) {
    ...
    b += (c - b) * t2;
    a += (b - a) * t2;
    return _round7(_atan22(b + (c + (segment[i2 + 7] - c) * t2 - b) * t2 - a, x) * _RAD2DEG3);
  }
  function sliceRawPath(rawPath, start, end) {
    end = _isUndefined3(end) ? 1 : _roundPrecise3(end) || 0;
    start = _roundPrecise3(start) || 0;
    var loops = Math.max(0, ~~(_abs2(end - start) - 1e-8)), path = copyRawPath(rawPath);
    if (start > end) {
      start = 1 - start;
      end = 1 - end;
  ...
  function getPositionOnPath(rawPath, progress, includeAngle, point) {
    ...
    i2 = ~~(i2 / resolution) * 6;
    a = segment[i2];
    result.x = _round7((t2 * t2 * (segment[i2 + 6] - a) + 3 * inv * (t2 * (segment[i2 + 4] - a) + inv * (segment[i2 + 2] - a))) * t2 + a);
    result.y = _round7((t2 * t2 * (segment[i2 + 7] - (a = segment[i2 + 1])) + 3 * inv * (t2 * (segment[i2 + 5] - a) + inv * (segment[i2 + 3] - a))) * t2 + a);
    if (includeAngle) {
  ...
  function pointsToSegment(points, curviness) {
    ...
    x !== nextX || y !== nextY || segment.length < 4 ? segment.push(_round7(nextX), _round7(nextY), _round7(nextX), _round7(nextY)) : segment.length -= 2;
    if (segment.length === 2) {
  ...
  function rawPathToString(rawPath) {
    ...
    for (s2 = 0; s2 < l; s2++) {
      segment = rawPath[s2];
      result += "M" + _round7(segment[0]) + "," + _round7(segment[1]) + " C";
      sl = segment.length;
      for (i2 = 2; i2 < sl; i2++) {
        result += _round7(segment[i2++]) + "," + _round7(segment[i2++]) + " " + _round7(segment[i2++]) + "," + _round7(segment[i2++]) + " " + _round7(segment[i2++]) + "," + _round7(segment[i2]) + " ";
      }
      if (segment.closed) {
        result += "z";
      }
  ...
  // node_modules/.pnpm/gsap@3.12.2/node_modules/gsap/MotionPathPlugin.js
  ...
  _getGSAP5() && gsap5.registerPlugin(MotionPathPlugin);

  // src/js/secGrowthApp.js
  gsapWithCSS.registerPlugin(ScrollTrigger2, Flip, MotionPathPlugin);
  var flippedTriggers = [];
  var resetTimeout = null;
  function initGrowthAppAnims() {
    let glowTween;
    const triggers2 = document.querySelectorAll("[data-trigger-app]");
    ...
    function checkAllFlipped() {
      if (flippedTriggers.length === triggers2.length) {
        if (resetTimeout) {
          clearTimeout(resetTimeout);
        }
        resetTimeout = setTimeout(resetGrowthApp, 5e3);
      }
    }
    triggers2.forEach((trigger) => {
      ...
      let glowTimeline = gsapWithCSS.timeline({ paused: true }).to(designerGlow, {
        delay: 1.5,
        autoAlpha: 0.7,
        duration: 0.5
      }).to(designerGlow, {
      ...
      trigger.addEventListener("click", function() {
        ...
        gsapWithCSS.to(designerRowText, {
          delay: 1.5,
        ...
        gsapWithCSS.to(designerRowIcon, {
          delay: 1.5,
  ...
  function initGrowthAppScroll() {
    gsapWithCSS.set("[data-designer-app]", {
      x: "10rem"
    });
    gsapWithCSS.set("[data-app-pannel]", {
      x: "-101%"
    });
    const stGrowthScrollIn = ScrollTrigger2.create({
      trigger: "[data-growth-apps]",
      start: "top center",
      once: true,
      onEnter: () => {
        gsapWithCSS.to("[data-designer-app]", {
          x: "0rem",
          duration: 1.5,
          ease: "power2.inOut"
        });
        ...
        gsapWithCSS.to("[data-app-pannel]", {
          delay: 0.75,
          x: "0%",
          duration: 1,
          ease: "power2.inOut"
  ...
  function initGrowthAppRotate() {
    ...
    const stGrowthRotate = animations.map(({ element, path, start, end, direction }) => {
      ...
      if (el && motionPathElement) {
        const animation = gsapWithCSS.to(el, {
          scrollTrigger: {
            trigger: "[data-growth-apps]",
            start: "top bottom",
            end: "bottom top",
        ...
        return ScrollTrigger2.getById(animation.scrollTrigger.id);
      }
      return null;
    }).filter(Boolean);
    return stGrowthRotate;
  }
  var growthAppScrollInstance;
  var growthAppRotateInstances;
  function refreshGrowthApp() {
    if (growthAppScrollInstance)
      growthAppScrollInstance.refresh();
  ...
  // src/js/secGrowthCollaboration.js
  var userInteracted = false;
  var growthCollabScrollInstances = [];
  function initGrowthCollabScroll() {
    ...
    gsapWithCSS.set(collabDesigner, { y: "10rem" });
    gsapWithCSS.set(commentPins, { y: "10rem" });
    gsapWithCSS.set(collabDim, { autoAlpha: 0 });
    gsapWithCSS.set(commentRipple, { autoAlpha: 0, scale: 0 });
    commentMain.addEventListener("click", function() {
      userInteracted = true;
      commentWrap.setAttribute("data-growth-comment-wrap", "open");
      gsapWithCSS.to(collabDim, { autoAlpha: 0, duration: 0.6, overwrite: true });
      commentMain.setAttribute("data-comment-pannel", "open");
      gsapWithCSS.to(commentRipple, {
        autoAlpha: 0,
        scale: 0,
        duration: 0.6,
        ease: "power2.inOut"
    ...
    clearButton.addEventListener("click", function() {
      ...
      gsapWithCSS.to(collabDim, { autoAlpha: 0.8, duration: 0.6 });
      ...
      gsapWithCSS.set(commentResult, { display: "none", autoAlpha: 0 });
    ...
    growthCollabScrollInstances.push(
      ScrollTrigger2.create({
        ...
        once: true,
        onEnter: () => {
          gsapWithCSS.to(collabDesigner, {
            y: "0rem",
            duration: 1.5,
            ease: "power2.inOut"
          });
          gsapWithCSS.to(commentPins, {
            y: "0rem",
            duration: 1.5,
            ease: "power2.inOut",
            stagger: 0.2
          });
          gsapWithCSS.to(collabDim, {
            autoAlpha: 0.8,
            duration: 1.5,
            ease: "power2.inOut"
          });
  ...
  function animateRippleLines() {
    ...
    setTimeout(animateRippleLines, totalDuration * 1e3);
  }
  function initGrowthCollabForm() {
    ...
    gsapWithCSS.set(commentResult, {
      display: "none",
      autoAlpha: 0
    });
    form.addEventListener("click", function(e2) {
      if (e2.target && e2.target.getAttribute("data-growth-comment-submit") !== null) {
  ...
  // node_modules/.pnpm/typed.js@2.0.16/node_modules/typed.js/dist/typed.module.js
  function t() {
  ...
  // src/js/secGrowthLocal.js
  var userInteracted2 = false;
  var growthLocalScrollInstances = [];
  function initGrowthLocalType() {
    let isTranslated = false;
    document.querySelector("[data-loc-trigger]").addEventListener("click", function() {
      userInteracted2 = true;
      const elementsToTranslate = document.querySelectorAll(
        "[data-loc-translate]"
      );
      elementsToTranslate.forEach((el) => {
        const originalText = el.getAttribute("data-loc-original") || el.textContent;
      ...
      if (triggerTextElement) {
        ...
        let typeSpeed = 20;
        let backSpeed = 20;
        const speedAdjust = triggerTextElement.getAttribute("data-speed-adjust");
        if (speedAdjust) {
          typeSpeed = typeSpeed / parseFloat(speedAdjust);
          backSpeed = backSpeed / parseFloat(speedAdjust);
        }
        const textToTypeForTrigger = isTranslated ? originalTriggerText : "";
        new i(triggerTextElement, {
  ...
  // src/js/secGrowthSEO.js
  gsapWithCSS.registerPlugin(CSSPlugin);
  var blurValue2 = 6;
  var animationTimeout;
  var userInteracted3 = false;
  var growthSEOScrollInstances = [];
  function initSeoRippleLines() {
      ...
      rippleLines.forEach((rippleLine, index) => {
        gsapWithCSS.to(rippleLine, {
          ...
          onStart: function() {
            ...
            rippleLine.style.boxShadow = `0px 1px ${blurValue2}px 0px rgba(1, 215, 34, 0.40)`;
            blurValue2 += 2;
          }
        });
      });
      const totalDuration = rippleLines.length * 0.6;
      animationTimeout = setTimeout(animateRippleLines2, totalDuration * 1e3);
    }
    ...
    if (seoButton) {
      seoButton.addEventListener("mouseenter", () => {
        ...
        gsapWithCSS.killTweensOf(rippleLines);
        resetRippleLines();
      });
  ...
  function initGrowthSEOInteractions() {
    ...
    buttons.forEach((button) => {
      button.addEventListener("click", function() {
        ...
        codeWrap.forEach((codeWrap2) => {
          if (codeWrap2) {
            codeWrap2.setAttribute("pointer-none", "");
          }
        });
        ...
        gsapWithCSS.to("[growth-seo-button]", {});
        gsapWithCSS.to("[data-og-hover]", {
          autoAlpha: 0,
          duration: 1.5,
          ease: "power3.out"
        });
          ...
          new i(el, {
            ...
            onComplete: () => {
              ...
              if (completedElementsCount === textElements.length) {
                ...
                gsapWithCSS.to('[data-reduce-target="height"]', {
                  delay: 1,
                  autoAlpha: 0,
                  height: "0px",
                  duration: 0.6,
                ...
                gsapWithCSS.to('[data-reduce-target="style"]', {
                  delay: 1,
                ...
                gsapWithCSS.to("[data-growth-seo-final-wrap]", {
                  delay: 1,
                  color: "var(--main-dark)",
                  padding: "1rem",
                ...
                gsapWithCSS.to("[growth-seo-og-inputs]", {
                  delay: 1,
                  // background: "var(--main-light)",
                  gridRowGap: "0rem",
                  duration: 0.6,
                ...
                gsapWithCSS.to("[data-growth-seo-og-field-flex]", {
                  delay: 1,
                  gridRowGap: "0rem",
                  duration: 0.6,
                  ease: "power3.out"
                });
                gsapWithCSS.to(".growth_seo-og-input.is--field", {
                  delay: 1,
                  minHeight: "0rem",
                  duration: 0.6,
                  ease: "power3.out"
                });
                gsapWithCSS.to(".growth_seo-og-input.is--textarea", {
                  delay: 1,
                  minHeight: "0rem",
                  duration: 0.6,
                  ease: "power3.out"
                });
                gsapWithCSS.to("[growth-seo-dots-wrap]", {
                  delay: 1.5,
                  autoAlpha: 0,
                  duration: 1,
                  ease: "power3.out"
                });
                gsapWithCSS.to("[data-seo-code-button]", {
                  delay: 1.5,
                  autoAlpha: 0,
                  duration: 1,
                  ease: "power3.out"
              ...
              if (completedElementsCount === textElements.length) {
                gsapWithCSS.to("[growth-seo-code-img]", {
                  delay: 1.5,
                  clipPath: "inset(0% 0% 0% 0%)",
                  duration: 1,
                  ease: "power3.in"
                });
                gsapWithCSS.to("[growth-seo-code-wrap]", {
                  delay: 1.5,
                  height: "25rem",
                  duration: 1,
                  ease: "power3.out"
                });
                gsapWithCSS.delayedCall(7, resetGrowthSEOInteractions);
              }
            }
          });
        });
  ...
  function resetGrowthSEOInteractions() {
    ...
    const codeWrap = document.querySelectorAll("[growth-seo-trigger]");
    codeWrap.forEach((codeWrap2) => {
      if (codeWrap2 && codeWrap2.hasAttribute("pointer-none")) {
        codeWrap2.removeAttribute("pointer-none");
      }
    });
    const codeText = document.querySelector("[growth-seo-code-text]");
    if (codeText) {
  ...
  // src/js/secMadeInWebflow.js
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  madeScrollInstances = [];
  function initMadeBadgeScroll() {
    madeScrollInstances.push(
      gsapWithCSS.to("[data-miw-outer-wrap]", {
        scrollTrigger: {
          trigger: "[miw-trigger]",
          start: "bottom bottom",
          end: "bottom top",
  ...
  function initMadeImgMouseFollow() {
    ...
    triggerElement.addEventListener("mousemove", (event2) => {
      const bounds = triggerElement.getBoundingClientRect();
      const x = (event2.clientX - bounds.left) / bounds.width * 2 - 1;
      const y = (event2.clientY - bounds.top) / bounds.height * 2 - 1;
  ...
  function initMadeFadeIn() {
    ...
    gsapWithCSS.set(targetElements, {
      autoAlpha: 0,
      scale: 0.7,
      y: "5em"
    });
    madeScrollInstances.push(
      gsapWithCSS.to(targetElements, {
        autoAlpha: 1,
        scale: 1,
        y: 0,
        ease: "power2.inOut",
        stagger: 0.1,
        // this can be adjusted based on the desired effect
        duration: 2,
  ...
  // src/js/secFooterCTA.js
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  var footerScrollInstances = [];
  function initFooterCTA() {
    ...
    gsapWithCSS.set([footerImg1, footerImg2, footerImg3], { y: "10rem", autoAlpha: 0 });
    footerScrollInstances.push(
      gsapWithCSS.to([footerImg1, footerImg2, footerImg3], {
        scrollTrigger: {
          trigger: footerTrigger,
          start: "top 90%",
          once: true
          // depends on whether you want to repeat the animation every time it comes into view
        },
        y: "0rem",
        duration: 1.5,
        autoAlpha: 1,
    ...
    footerTransWrap.addEventListener("mousemove", function(e2) {
      ...
      footerTrans.forEach((el, index) => {
        ...
        gsapWithCSS.to(el, { x: transX, y: transY, duration: 0.3, ease: "power2.out" });
      });
    });
  }
  function refreshFooterScrollInstances() {
    footerScrollInstances.forEach((instance) => instance.scrollTrigger.refresh());
  }
  function initFooterCTASection() {
    if (!window.prm) {
      initFooterCTA();
    }
  }
  ...
  // src/js/secFeatures.js
  function initFeaturesStates() {
    const duration = 0;
    ...
    featureTabs.forEach((tab) => {
      ...
      if (!tabReveal || !progressTrack)
        return;
      gsapWithCSS.to(progressBarTip, {
        autoAlpha: 0
      });
      if (isActive) {
        gsapWithCSS.to(tabReveal, {
          height: "auto",
          autoAlpha: 1,
          clipPath: "inset(0% 0% 0% 0%)",
          duration,
  ...
  function initFeaturesVideoLoad() {
  ...
  function initFeatureTabs() {
    ...
    function updateProgressBar(tab, videoElement) {
      ...
      gsapWithCSS.to(progressBarFill, {
        scaleX: progress,
        scaleY: 1,
        ease: "none",
        onComplete: () => {
    ...
    featureTabs.forEach((innerTab) => {
      ...
      const target = Array.from(featureTargets).find(
        (target2) => target2.getAttribute("data-features-target") === triggerValue
      );
      const videoElement = target.querySelector("[data-features-video-src]");
      if (innerTab.getAttribute("data-features-tab") === "active") {
        gsapWithCSS.set(innerTab.querySelector("[data-feature-tab-progress-track]"), {
          scaleX: 1,
          autoAlpha: 1,
          duration,
          ease: "power2.inOut"
        ...
        if (videoElement) {
          const timeUpdateListener = () => updateProgressBar(innerTab, videoElement);
        ...
        gsapWithCSS.set(innerTab.querySelector("[data-features-tab-reveal]"), {
          height: 0,
          autoAlpha: 0,
          clipPath: "inset(0% 0% 100% 0%)"
        });
      ...
      tab.addEventListener("click", () => {
        ...
        featureTargets.forEach((target) => {
          ...
          if (target.getAttribute("data-features-target") === triggerValue) {
            gsapWithCSS.to(target, {
              ...
              onComplete: function() {
                if (videoElement) {
                  ...
                  videoElement.play();
                  const timeUpdateListener = () => updateProgressBar(tab, videoElement);
            ...
            gsapWithCSS.to(target, {
              ...
              // ease: "power2.inOut",
              onComplete: function() {
                gsapWithCSS.to(target, { display: "none" });
                if (videoElement) {
                  videoElement.pause();
                  videoElement.currentTime = 0;
                }
        ...
        featureTabs.forEach((innerTab) => {
          ...
          if (innerTab === tab) {
            ...
            gsapWithCSS.to(innerTab.querySelector("[data-features-tab-reveal]"), {
              height: "auto",
              autoAlpha: 1,
              clipPath: "inset(0% 0% 0% 0%)",
              duration,
            ...
            gsapWithCSS.to(innerTab.querySelector("[data-feature-tab-progress-track]"), {
              scaleX: 1,
              autoAlpha: 1,
              duration,
              ease: "power2.inOut"
  ...
  function initEnterpriseGlow() {
    ...
    enterpriseCards.forEach((card) => {
      card.addEventListener("mousemove", (e2) => {
        const cardBounds = card.getBoundingClientRect();
        const mouseX = e2.clientX - cardBounds.left;
        const mouseY = e2.clientY - cardBounds.top;
      ...
      card.addEventListener("mouseleave", () => {
        ...
        glowElements.forEach(
          (element) => gsapWithCSS.to(element, {
            x: "0px",
            y: "0px",
            ease: "power2.out",
            duration: 1,
  ...
  // src/js/secGlPlaceholder.js
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  function initGlPlaceholder() {
    if (typeof gsapWithCSS === "undefined" || typeof ScrollTrigger2 === "undefined") {
    ...
    let duration = "1.5";
    gsapWithCSS.set(plPanels, { autoAlpha: 0, y: "10rem" });
    gsapWithCSS.set(plImg, { autoAlpha: 0, y: "101%", scale: 0.9 });
    ScrollTrigger2.create({
      trigger: plTrigger,
      start: "top 85%",
      onEnter: () => {
        gsapWithCSS.to(plDim, {
          autoAlpha: 0,
          duration,
          ease: "power2.inOut"
        });
        gsapWithCSS.to(plGlow, {
          autoAlpha: 0,
          duration,
          ease: "power2.inOut"
        });
        gsapWithCSS.to(plPanels, {
          delay: 0.4,
          autoAlpha: 1,
          y: "0rem",
          stagger: 0.2,
  ...
  function initGlPlaceholderSection() {
    if (window.isTabletOrBelow) {
      if (!window.prm) {
        initGlPlaceholder();
      }
